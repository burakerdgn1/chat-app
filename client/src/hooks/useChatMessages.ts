...
import { addMessage, resetMessagesState, setMessages } from "../redux/slices/messagesSlice";
...
const useChatMessages = (currentUser: User | null, user: User | null) => {
    ...
    const conversations = useAppSelector(state => state.messageState.conversations);
